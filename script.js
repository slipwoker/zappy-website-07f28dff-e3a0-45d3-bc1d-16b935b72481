document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const ERROR_ATTR = 'data-error-message';
    ...
    function getErrorContainer(field) {
      const wrapper = field.closest('.form-group, .field-wrapper, [data-field]');
      if (wrapper) {
        let errorEl = wrapper.querySelector('.field-error, [data-field-error]');
        if (!errorEl) {
    ...
    function validateField(field) {
      ...
      if (field.required || field.hasAttribute('required')) {
        if (!validators.required(value)) {
          const msg = field.getAttribute(ERROR_ATTR) ||
      ...
      if (type === 'email' || field.hasAttribute('data-validate-email')) {
        if (!validators.email(value)) {
          const msg = field.getAttribute('data-email-message') ||
      ...
      if (type === 'tel' || field.hasAttribute('data-validate-tel')) {
        if (value.trim() && !validators.tel(value)) {
          const msg = field.getAttribute('data-tel-message') ||
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (!validators.minlength(value, min)) {
          const msg = field.getAttribute('data-minlength-message') ||
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (!validators.maxlength(value, max)) {
          const msg = field.getAttribute('data-maxlength-message') ||
    ...
    contactForm.addEventListener('submit', function (e) {
      const fields = getFormFields(contactForm);
  ...
  const ANIMATION_SELECTOR = '.fade-in, [data-animate], .animate-on-scroll';

  function initScrollAnimations() {
    const animatableElements = document.querySelectorAll(ANIMATION_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '07f28dff-e3a0-45d3-bc1d-16b935b72481',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '07f28dff-e3a0-45d3-bc1d-16b935b72481';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '07f28dff-e3a0-45d3-bc1d-16b935b72481';
